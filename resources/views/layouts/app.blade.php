...
<body>
    <nav class="navbar">
        <a href="{{ route('dashboard') }}" class="navbar-brand">Stock MS</a>
        <ul class="navbar-nav">
            <li><a href="{{ route('dashboard') }}" class="nav-link">Dashboard</a></li>
            <li><a href="{{ route('products.index') }}" class="nav-link">Products</a></li>
            <li><a href="{{ route('productin.index') }}" class="nav-link">Stock In</a></li>
            <li><a href="{{ route('productout.index') }}" class="nav-link">Stock Out</a></li>
            <li>
